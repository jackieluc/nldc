const faq = [
	...
	},
	{
		...
		answer:
			'Yes! You can purchase your tickets at <a href="https://bit.ly/Y2B2019Forum" target="_blank" rel="noopener noreferrer">bit.ly/Y2B2019Forum</a> and attend our Launch and Youth to Business Forum on May 1-2.',
	},
	{
	...
	},
	{
		...
		answer:
			'Please bring <span>$40+</span> to be safe. These can cover night event tickets, merchandise, raffles, etc...',
	},
	{
		question: 'What is the legal drinking age in Calgary, Alberta?',
		answer:
			'The legal drinking age is <span>18 years old</span>. Please bring <span>2 pieces of government ID</span> for access to night events.',
	},
	{
		question: 'What do I need to pack?',
		answer:
			'Some basic items include toiletries, pajamas, shoes, AIESEC swag, laptop, charger, etc... A detailed list will be provided in April.',
	},
	{
		question: 'I am planning to drive, will I get free parking?',
		answer:
			'Yes, all conference delegates will receive a parking pass. You will need to submit a request here at <a href="https://bit.ly/NLDCParking" target="_blank" rel="noopener noreferrer">bit.ly/NLDCParking</a>.',
	},
	{
		question: 'When should I book my flight to return home?',
		answer:
			'The conference checkout will be on May 6. We are planning to host a Banff Retreat after NLDC from May 6 to 7 so please book your flight after May 7 if you would like to attend.',
	},
]

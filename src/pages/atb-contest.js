...
const Title = styled.h1`
  ...
  text-align: center;
  font-size: 2rem;
  ${Media.bigPhone`font-size: 2.5rem;`}
      ...
      <Half gradient>
        ...
        <ContestDescription>
          ...
          <EligibilityDescription>
            ...
            <a href="/" target="_blank" rel="noopener noreferrer">Click here for full contest terms & conditions.</a>
          </EligibilityDescription>
        </ContestDescription>
      </Half>
      <Half>
        ...
        <ContestDescription>
          ...
          <p>
            A Panel of 4 Judges (2 from ATB, 2 from AIESEC Calgary) will review each entry for eligibility, creativity, completeness and applicability of response. 10 of those entries will be randomly chosen for free registration to NLDC (valued at $400).
          </p>
        </ContestDescription>
      </Half>
    </Wrapper>
